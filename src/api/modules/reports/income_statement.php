...
class IncomeStatementActions {
    ...
    public static function fetch_graph_data_points(string $begin_time, string $end_time, array $locations): array {
        ...
        // Convert Date
        $begin_time = Utils::get_YYYY_mm_dd(Utils::convert_client_app_timestamp_to_localtime($begin_time, StoreDetails::EDMONTON));
        $end_time = Utils::get_YYYY_mm_dd(Utils::convert_client_app_timestamp_to_localtime($end_time, StoreDetails::EDMONTON));
