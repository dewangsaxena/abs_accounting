    ...
    private static function email(int $receipt_id, array $transactions=[]): array {
        ...
        try {
            ...
            $is_email_sent = Email::send(
                subject: "Receipt #$receipt_id from ". STORE_DETAILS[$store_id]['email']['from_name'][SYSTEM_INIT_MODE],
